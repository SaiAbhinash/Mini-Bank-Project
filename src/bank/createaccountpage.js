    ...
    return (
        <div class="container">
            <form onSubmit={handleCreateAccount}>
                ...
                <select name="accountType" value="AccountTyppe">
                    <option value="Checking Account">Savings Account</option>
                    <option value="Savings Accounts">Current Account</option>
                    <option value="Checking Account">Recurring Deposit Account</option>
                    <option value="Savings Accounts">Fixed Deposit Account</option>
                </select>
